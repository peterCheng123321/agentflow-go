...
// Chinese / informal labels → canonical matter_type used in the app
...
func intakeTextUsable(text string) bool {
	...
	// Allow shorter OCR snippets so intake still runs on brief pages or partial scans
...
func (s *Server) analyzeBatchFromOCR(docs map[string]string) batchAnalysisJSON {
